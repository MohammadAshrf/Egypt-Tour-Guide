...
public class LuxorDetailActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        luxor = luxorDAO.selectPlaceByTitle (title + 1);
        tvPlaceTitle.setText (luxor.title);
        tvPlacePlot.setMovementMethod (new ScrollingMovementMethod ());
        tvPlacePlot.setText (luxor.description);
        /**
         * Open Image on FullScreen
         */
        ivPic.setOnClickListener (v -> {
            Intent in = new Intent (LuxorDetailActivity.this, ImageViewerActivity.class);
            in.putExtra ("url", (luxor.picture));
            startActivity (in);
        });
        Picasso.get ().load (luxor.picture).placeholder (R.drawable.placeholder).into (ivPic);
    ...
    public void star(View view) {
        ...
        if (starOn) {
            ...
            favourite.picture = luxor.picture;
...
//            Picasso.get ().load (favourite.picture).placeholder (R.drawable.placeholder).into (ivPicture);
    ...
    public void Favourites(MenuItem item) {
        Intent in = new Intent (LuxorDetailActivity.this, FavouriteActivity.class);
        startActivity (in);
    }
}